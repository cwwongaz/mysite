    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commenter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client_comment', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='item',
            fields=[
                ...
                ('item_brand', models.TextField(max_length=100)),
                ...
                ('comments', models.ManyToManyField(blank=True, related_name='item', to='webstore.comment')),
            ],
        ),
        migrations.CreateModel(
            name='client',
